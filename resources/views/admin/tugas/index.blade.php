                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        @endif
                           ...
                           <a href="{{route('tugas.create')}}" class="btn btn-primary pull-righ"> Tambah Data </a>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$dt->ket_tugas}}</td>
                                            <td>{{$dt->status_tugas}}</td>
                                            <td> <a href="{{route('tugas.edit', $dt->id)}}" class='btn btn-primary'>Edit</a></td>
                                            <td> <form action="{{route('tugas.destroy',$dt->id)}}" method="post"> 
                                                @csrf   
                                                @method('DELETE')
